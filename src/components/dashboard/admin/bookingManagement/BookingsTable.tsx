                  ...
                  {data.map((booking, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-3">
                            <div className="w-8 h-8 bg-gradient-to-br from-amber-500 to-amber-600 rounded-full flex items-center justify-center text-white font-semibold text-xs shadow-sm">
                              {booking.boat?.captain?.firstName?.[0]}
                              {booking.boat?.captain?.lastName?.[0]}
                            </div>
                            <div>
                        ...
                        <td className="px-6 py-4">
                          <span
                            className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium ${
                              statusProps.color === "#10B981"
                                ? "bg-green-100 text-green-800"
                                : statusProps.color === "#F59E0B"
                                  ? "bg-amber-100 text-amber-800"
                                  : statusProps.color === "#EF4444"
