      ...
      <div className="container mx-auto px-5 xl:px-0 relative">
        <div className="flex items-center justify-between font-satoshi">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            {/* Conditional Button Logic for Desktop */}
            {mounted && user ? (
              <Button
                link={
                  user.role === "USER"
              ...
              <Button
                link={
                  mounted && user
                    ...
                    : "/login?redirect=/dashboard/check-your-trip"
                }
                variant="primary"
                className="flex items-center gap-3 font-bold w-44"
              >
            ...
            <div className="pt-4 mt-4 flex flex-col gap-3 space-y-3 w-full">
              {!mounted ? (
                ...
                <>
                  <Link
                    href="/signup"
                    className="hover:text-[#FF9500] w-full"
              ...
              {/* Conditional Button Logic for Mobile */}
              {!mounted ? (
                <div className="animate-pulse h-10 w-24 bg-gray-200 rounded"></div>
              ) : user ? (
                <Button
                ...
                <Button
                  link={
                    mounted && user ? "/dashboard/check-your-trip" : "/login"
                  }
                  variant="primary"
                >
                  List your boat
